...
\textbf{Análise dos erros.} A Figura~\ref{fig:parity} compara, para cada ponto de teste, o valor real com o valor previsto. Se o modelo acertasse tudo, todos os pontos ficariam sobre a linha tracejada. O que se observa é que \textbf{as previsões ficam mais próximas da média do que os valores reais}: o modelo acerta bem os valores intermediários, mas erra os extremos, principalmente os mais altos. Por exemplo, para o maior valor real do teste (2,66), o modelo previu 0,77; e, enquanto os valores reais vão de $-1{,}49$ a $2{,}66$, as previsões ficam entre $-1{,}17$ e $1{,}29$. No gráfico da direita, os pontos acima da linha zero são casos em que o modelo previu \textbf{abaixo} do valor real. Esse comportamento é esperado com poucos dados e muito ruído: prever perto da média é a forma de errar menos em média, ao custo de errar mais nos extremos. Nenhum dos componentes testados corrigiu isso.
